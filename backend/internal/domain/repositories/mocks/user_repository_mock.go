...
func (mr *MockUserRepositoryMockRecorder) DeleteToken(ctx, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteToken", reflect.TypeOf((*MockUserRepository)(nil).DeleteToken), ctx, token)
}

// GetUserByID mocks base method.
func (m *MockUserRepository) GetUserByID(ctx context.Context, userID string) (*entities.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) StoreToken(ctx context.Context, token *entities.AuthToken) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) StoreToken(ctx, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreToken", reflect.TypeOf((*MockUserRepository)(nil).StoreToken), ctx, token)
}

// ValidateToken mocks base method.
func (m *MockUserRepository) ValidateToken(ctx context.Context, token string) (*entities.AuthToken, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) ValidateToken(ctx, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateToken", reflect.TypeOf((*MockUserRepository)(nil).ValidateToken), ctx, token)
}
